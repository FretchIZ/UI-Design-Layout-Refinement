...
% ── Metadata ──────────────────────────────────────────────────
\title{AI Education \& Engineering Platform UI Layout: A Component-Based Architecture for\\Interactive AI-Assisted Learning Interfaces}
...
In this paper, we describe the design and implementation of an AI Education \& Engineering Platform UI layout system for an AI learning companion named {\itshape Elice}. The system integrates a chat-based tutoring interface, interactive neural network diagrams, mathematical equation display, code panels with syntax highlighting, voice-controlled interaction, and animated visual feedback --- all within a cohesive dark-themed design system.
